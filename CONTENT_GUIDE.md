...
want pinned to the top, and pinned entries sort ahead of the rest by that number.
...
year: 2026
question: "Does a truncated spectral transfer function beat Muon's flat whitening?"
summary: >
...
The body is Markdown and takes as much room as the project needs. It renders
on the entry's own page, below everything in the frontmatter.
```
...
---
name: "HarmonyEngine"
blurb: "A CLI that takes a monophonic melody and returns k-best harmonizations in eight style packs."
stack: ["Python"]
year: 2026
---
